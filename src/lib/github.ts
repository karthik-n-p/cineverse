...
export const DISTRICT_NAMES: Record<string, string> = {
  ...
  creator: 'Creator',
  // Movie genre districts
  action: 'Action District', comedy: 'Comedy Lane', drama: 'Drama Avenue',
  horror: 'Horror Alley', scifi: 'Sci-Fi Quarter', romance: 'Romance Boulevard',
  thriller: 'Thriller Row', animation: 'Animation Park',
  documentary: 'Documentary Square', other: 'Indie Corner',
};
...
export const DISTRICT_COLORS: Record<string, string> = {
  ...
  creator: '#eab308',
  // Movie genre districts
  action: '#ef4444', comedy: '#fbbf24', drama: '#3b82f6',
  horror: '#7c3aed', scifi: '#06b6d4', romance: '#ec4899',
  thriller: '#64748b', animation: '#22c55e',
  documentary: '#f97316', other: '#a855f7',
};
...
export const DISTRICT_DESCRIPTIONS: Record<string, string> = {
  ...
  // Movie genre districts
  action: 'Explosions, chases, and epic battles.',
  comedy: 'Laughs, gags, and feel-good stories.',
  drama: 'Deep stories and powerful performances.',
  horror: 'Fear, suspense, and the supernatural.',
  scifi: 'Future tech, space, and the unknown.',
  romance: 'Love stories and heartfelt moments.',
  thriller: 'Edge-of-your-seat tension.',
  animation: 'Animated worlds and colorful characters.',
  documentary: 'Real stories, real people.',
  other: 'Unique films that defy genre.',
};
...
const LANGUAGE_TO_DISTRICT: Record<string, string> = {
  ...
  // Movie genre names → districts
  Action: 'action', Adventure: 'action', War: 'action', Western: 'action',
  Comedy: 'comedy', Family: 'comedy',
  Drama: 'drama', History: 'drama', Music: 'drama',
  Horror: 'horror',
  'Science Fiction': 'scifi', Fantasy: 'scifi',
  Romance: 'romance',
  Thriller: 'thriller', Crime: 'thriller', Mystery: 'thriller',
  Animation: 'animation',
...
export function inferDistrict(lang: string | null): string {
  ...
  return LANGUAGE_TO_DISTRICT[lang] ?? 'other';
}
